...
<main class="main-container-pricing">
    ...
    <section class="ask-section">
        ...
        <div class="ask-content">
            <h3><strong>Real Questions. Real Answers.</strong></h3>
        ...
        <div class="ask-submit">
            ...
            <path d="M10,40 C40,0 60,0 90,40" stroke="white" stroke-width="2" fill="none" />
            <path d="M85,35 L90,40 L85,45" stroke="white" stroke-width="2" fill="none" />
            </svg>
